...
void set_new_global_location(void){
    ...
    my_goal_position.pose.position.altitude=global_position.altitude+50;/// I think sth is wrong between attiude of  mavros/attiude  and mavros/global // offset is 48 
